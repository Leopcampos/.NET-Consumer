...
public class CheckoutService
{
    ...
    public async Task<CheckoutResponse> PostAsync(DetalhesPedido model)
    {
        ...
        using (var httpClient = new HttpClient())
        {
            ...
            var checkoutRequest = new CheckoutRequest
            {
                ...
                {
                    Name = model.Cliente.Nome,
                    Email = model.Cliente.Email,
                    Cpf = model.Cliente.Cpf
                },
                CreditCard = new CreditcardRequest
                {
                    CardNumber = model.Cobranca.NumeroCartao,
                    CardholderName = model.Cobranca.NomeImpressoNoCartao,
                    ExpirationMonth = model.Cobranca.MesValidade,
                    ExpirationYear = model.Cobranca.AnoValidade,
                    SecurityCode = model.Cobranca.CodigoSeguranca
                }
            };
